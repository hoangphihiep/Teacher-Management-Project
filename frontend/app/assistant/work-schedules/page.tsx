...
export default function AssistantWorkSchedulePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Lịch làm việc trợ giảng</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>🟢 Hỗ trợ giảng dạy • 🔵 Công việc hành chính • 🟡 Họp nhóm</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  return (
                    <div key={`schedules-${day}`} className="relative">
                      {daySchedules.map((schedule) => {
                        ...
                        const topOffset = startIndex * 68
                        const height = duration * 68
